...
INSERT INTO `competence` VALUES (1,'Korvgrillning',1),(2,'Karuselldrift',1);
...
--
-- Table structure for table `competence_profile_sv`
--

DROP TABLE IF EXISTS `competence_profile_sv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `competence_profile_sv` (
  `competence_profile_id` bigint(20) NOT NULL,
  `person_id` bigint(20) DEFAULT NULL,
  `competence_id` bigint(20) DEFAULT NULL,
  `years_of_experience` decimal(4,2) DEFAULT NULL,
  `version` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`competence_profile_id`),
  KEY `compprof_competence_id_sv_idx` (`competence_id`),
  KEY `compprof_person_id_sv_idx` (`person_id`),
  CONSTRAINT `compprof_competence_id_sv` FOREIGN KEY (`competence_id`) REFERENCES `competence_sv` (`competence_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `compprof_person_id_sv` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `competence_profile_sv`
--

LOCK TABLES `competence_profile_sv` WRITE;
/*!40000 ALTER TABLE `competence_profile_sv` DISABLE KEYS */;
/*!40000 ALTER TABLE `competence_profile_sv` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `job_sv` (
  ...
  `version` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fn_person_idx` (`recruiter_person_id`),
  CONSTRAINT `fn_person` FOREIGN KEY (`recruiter_person_id`) REFERENCES `person` (`person_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `person` VALUES (1,'Greta','Borg','19871212-1411','borg@kth.se',1,'borg',1),(2,'Per','Strand','19671212-1211','per@strand.kth.se',2,'per',1);
...
INSERT INTO `role` VALUES (1,'recruit',1),(2,'applicant',1);
...
INSERT INTO `user` VALUES ('borg','kIIjHXDQfQS3/t6FpUMwPweWCaQUd1qn9jO7eXHo8uxnGtpAY4EGZQyrDIQG9gIN','',1),('per','pass','',1);
...
-- Dump completed on 2015-03-15 21:57:42
